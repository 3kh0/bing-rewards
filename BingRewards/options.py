...
def parse_setup_args():
    ...
    setup_parser.add_argument(
        ...
        nargs='?',
        help=
        'Discord channel webhook. Can be generated by channel settings > integrations > webhooks > New Webhook > Name doesnt matter, copy the Webhook URL and rerun "setup.py -d <webhook URL>"'
    )
    ...
    setup_parser.add_argument(
        ...
        help=
        'The sheetId that you want to write to. More info here: https://stackoverflow.com/a/36062068'
    )
    setup_parser.add_argument(
        '-gstn',
